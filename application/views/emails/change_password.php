            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h3>Hola,</h3>
                            <h4>Recibimos una solicitud de cambio de contraseña para tu cuenta de Loteria del Quindio.</h4>
                            <br>
                ...
                <tr>
                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                        <div style="margin-top: 50px; margin-bottom: 50px; ">
                            <a href="<?= $change_password_url; ?>"  class='btn-link' style="color: #ffffff; text-decoration: none; width: 100; ">Cambiar contraseña</a>
                        </div>
                    </td>
                </tr>
            </table>

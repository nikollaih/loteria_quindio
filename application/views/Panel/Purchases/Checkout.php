            ...
            <div class="col-md-8 order-md-1">
               ...
               <div class="row">
                  <div class="col-md-4 mb-3">
                     ...
                     <input value="<?= (is_array($draw_number)) ? $draw_number["number"] : "" ?>" maxlength="4" minlength="4" name="purchase[number]" type="number" class="form-control bill-data" id="bill-number" placeholder="0000" required="" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
                     <div class="invalid-feedback">
               ...
               <div class="d-block my-3">
                  <div class="custom-control custom-radio">
                     ...
                     <label class="custom-control-label" for="bank-purchase">PSE - Place To Pay</label>
                  </div>
                  <div class="custom-control custom-radio">

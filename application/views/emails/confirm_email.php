            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h3>Bienvenido,</h3>
                            <h4>Gracias por su nuevo registro dentro de  nuestra plataforma.</h4>
                            <br>
                            <h4>Para poder ingresar y disfrutar de los servicios que ofrecemos debe verificar su dirección de correo electronico dando click el siguiente enlace:</h4>
            			</div>
            		</td>
                </tr>
                <tr>
                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                        <div style="margin-top: 50px; margin-bottom: 50px; ">
                            <a href="<?= base_url().'usuarios/verify_email/' . $slug ?>"  class='btn-link' style="color: #ffffff; text-decoration: none; width: 100; ">Verificar</a>
                        </div>
                    </td>
                </tr>
            </table>

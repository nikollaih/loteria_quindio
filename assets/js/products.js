...
jQuery(document).on("click", ".edit-product-button", function() {
    set_update_product(jQuery(this).attr("data-id"), jQuery(this).attr("data-fractions-count"), jQuery(this).attr("data-fraction-value"));
});
...
function set_update_product(id, fractions_count, fraction_value) {
    if (id != null) {
